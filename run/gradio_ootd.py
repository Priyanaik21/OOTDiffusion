...
with block:
    ...
    with gr.Column():
        ...
        n_samples = gr.Slider(label="Images", minimum=1, maximum=4, value=1, step=1, visible=False)
        n_steps = gr.Slider(label="Steps", minimum=20, maximum=40, value=20, step=1, visible=False)
        # scale = gr.Slider(label="Scale", minimum=1.0, maximum=12.0, value=5.0, step=0.1)
        image_scale = gr.Slider(label="Guidance scale", minimum=1.0, maximum=5.0, value=2.0, step=0.1, visible=False)
        seed = gr.Slider(label="Seed", minimum=-1, maximum=2147483647, step=1, value=-1, visible=False)
    ...
    with gr.Column():
        ...
        n_samples_dc = gr.Slider(label="Images", minimum=1, maximum=4, value=1, step=1, visible=False)
        n_steps_dc = gr.Slider(label="Steps", minimum=20, maximum=40, value=20, step=1, visible=False)
        # scale_dc = gr.Slider(label="Scale", minimum=1.0, maximum=12.0, value=5.0, step=0.1)
        image_scale_dc = gr.Slider(label="Guidance scale", minimum=1.0, maximum=5.0, value=2.0, step=0.1, visible=False)
        seed_dc = gr.Slider(label="Seed", minimum=-1, maximum=2147483647, step=1, value=-1, visible=False)
